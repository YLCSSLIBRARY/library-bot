...
def expand_and_search_books(user_input, book_lines, max_results=20):
    ...
    synonyms_map = {
        ...
        "療癒": ["療癒", "舒緩", "放鬆", "安慰", "哭"],
        "叛逆": ["叛逆", "反叛", "唔聽話", "衝突", "誘惑"],
        "羞怯": ["尷尬", "怕醜", "怕羞", "面紅", "醜態", "犯錯", "跌倒", "出醜", "羞恥", "遮掩", "唔好意思"], # 專屬對接阿尷
...
if prompt := st.chat_input("你想搵咩書？或者同我傾下心事..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("「元天閱讀腦朋友」正在聽你傾訴，並在館藏中為你挑選心靈配方..."):
            ...
            【你的核心任務】：
            1. 請先用非常親切、溫慢、充滿校園關懷的廣東話口吻（中學老師與知心好友的雙重語氣），深入回應學生的心情 or 學術需求。在對話中，必須提及目前是由哪一位帶有「心心 Emoji」的「腦朋友」正在為他們調配這個處方。
