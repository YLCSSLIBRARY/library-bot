...
def expand_and_search_books(user_input, book_lines, max_results=20):
    ...
    # 【新功能：廣東話尋書口語過濾器】剝離干擾字，精準提取尋書核心主體
    stop_phrases = [
    ...
    # 【智能優化兜底機制】如果依然找不到，才進行加權單字匹配，並自動排除「書、本、上下冊」等圖書館高頻無效字
...
if prompt := st.chat_input("你想搵咩書？或者同我傾下心事..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("選書師正在感同身受，並在館藏中為你挑選心靈配方..."):
            ...
            【你的核心任務】：
            1. 請先用非常親切、溫暖、充滿校園關懷的廣東話口吻（中學老師的語氣），深入回應學生的心情或學術需求（例如讚賞他們對特定歷史課題的主動探究，或安慰其課業人際壓力）。
            ...
            4. 如果【相關館藏】為空或裡面確實沒有同學想要的特定主題書籍，請溫柔地安慰同學，說明這批精選暫時未涵蓋，並鼓勵他們換個說法，或隨時親自來圖書館櫃檯搵老師傾計，老師會為他們在全館系統手動選書。
